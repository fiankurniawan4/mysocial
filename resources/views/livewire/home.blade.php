<div>
    @foreach ($articles as $item)
        <div class="m-6">
            ...
            <div class="">
                <span class="text-gray-600">By: <a href="#"
    ...
    <div class="modal" role="dialog">
        <div class="modal-box">
            <h3 class="text-lg font-bold items-center">Post</h3>
            <form wire:submit='save'>
                ...
                <button type="submit"
                    class="bg-blue-500 modal-backdrop hover:bg-blue-700 text-white font-bold py-2 px-4 rounded hover:underline cursor-pointer transition" for="my_modal_7">Submit</button>
            </form>
        </div>
